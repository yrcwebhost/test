(function () {
  ...
  const DICTIONARY = {
    en: {
      ...
      homeAtAGlance: 'At a Glance',
      homeOpenItinerary: 'Open the itinerary',
      homeReadNext: 'Trip-wide Reading',
      homeSavedPeek: 'Your Bookmarks',
      homeSeeAll: 'See all',
    ...
    de: {
      ...
      homeAtAGlance: 'Auf einen Blick',
      homeOpenItinerary: 'Reiseroute öffnen',
      homeReadNext: 'Reise-Lektüre',
      homeSavedPeek: 'Deine Lesezeichen',
